...
export default function JoinUs() {
  ...
  return (
    <section id='joinus' className="bg-[#1a1a1a] text-white flex flex-col items-center py-12 px-4">
      <h1 className='text-white text-2xl md:text-3xl font-bold mb-10'>Join Us Today</h1>
      <img src="/hor-hero-bg.jpg" alt="Join us" className="max-w-2xl mb-8 rounded-lg" />
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-black shadow-xl transition-all">
                  <div className="flex justify-between items-center mb-4">
                    <Dialog.Title className="text-lg font-medium text-gray-900">Join Us</Dialog.Title>
